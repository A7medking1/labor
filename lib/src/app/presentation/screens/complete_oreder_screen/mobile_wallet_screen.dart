...
class MobileWalletScreen extends StatefulWidget {
  ...
  @override
  State<MobileWalletScreen> createState() => _MobileWalletScreen();
}

class _MobileWalletScreen extends State<MobileWalletScreen> {
...
*/
      ...
      ..loadRequest(Uri.parse(ApiPaymentConstant.mobileWalletIframe));
